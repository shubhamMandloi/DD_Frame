...
public class SeleniumUtils {
    ...
    public static void doubleClick(WebDriver driver, By locator, String eleDesc) {
        try {
            ...
            add_Log.info("Successfully double Click on element " + element + ".");
            Reporter.log("Successfully double Click on element " + element + ".");
        } catch (Exception e) {
    ...
    public static void enterText(WebDriver driver, By locator, Keys key, String eleDesc) {
    ...
    public static void rightClick(WebDriver driver, By locator, String eleDesc) {
        try {
            ...
            add_Log.info("Successfully right Click on element " + eleDesc + ".");
            Reporter.log("Successfully right Click on element " + eleDesc + ".");
        } catch (Exception e) {
    ...
    public static void verifyMessage(WebDriver driver, WebPageElements ele, String expectedMsg) {
        ...
        if (isAlertPresent(driver)) {
            if (!(Objects.requireNonNull(getAlertText(driver)).trim()).equalsIgnoreCase(expectedMsg)) {
    ...
    public static void WritePASSLog(String message, String subTestCaseNo) {
        add_Log.info(message + ", Hence "+subTestCaseNo+" Validation Successful.");
        Reporter.log(message + ", Hence "+subTestCaseNo+" Validation Successful.");
    }
